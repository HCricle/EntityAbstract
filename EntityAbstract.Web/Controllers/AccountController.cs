...
using EntityAbstract.Web.Models.AccountViewModels;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "登陆失败,可能密码或用户名错误,或者没确认邮箱.");
                    return View(model);
                }
            }
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new EaUser { UserName = model.Name, Email = model.Email, CreateTime = DateTime.Now, Type = "default"};
        ...
        public async Task<IActionResult> ExternalLoginConfirmation(ExternalLoginViewModel model, string returnUrl = null)
        {
            if (ModelState.IsValid)
            {
                ...
                var user = new EaUser { UserName = model.Email, Email = model.Email };
